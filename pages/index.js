...
export default function Home() {
  ...
  function startGameFunc() {
    ...
    setTimerVal(<Countdown date={Date.now() + 10000} zeroPadTime={2} renderer={renderer} onComplete={() => {setTimerDisabled(false); setSubmitBtnDisabled(true);}} />);
  }
      ...
      <main>
        ...
        <div className='flex justify-center items-center'>
          ...
          <div className='flex justify-center'>
            <form className='block md:flex md:items-center'>
